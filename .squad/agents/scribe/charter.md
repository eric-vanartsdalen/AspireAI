...
3. **Merge the decision inbox** from `.squad/decisions/inbox/` into `.squad/decisions.md`
...
7. **Summarize history** if any agent's `history.md` exceeds ~12KB
8. **Commit `.squad/` changes** via git (write msg to temp file, use -F)
