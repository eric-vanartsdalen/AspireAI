...
**I don't handle:** C# code (that's Jeff), architecture decisions (check with Bob), test strategy (Buster leads).
...
After making a decision others should know, write it to `.squad/decisions/inbox/jarvis-{brief-slug}.md` — the Scribe will merge it.
